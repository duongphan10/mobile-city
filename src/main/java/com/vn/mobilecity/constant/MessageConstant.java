...
public class MessageConstant {
    ...
    public static String DELETE_NEWS_TYPE_SUCCESSFULLY = "You successfully deleted the news type";
    public static String DELETE_NEWS_SUCCESSFULLY = "You successfully deleted the news";
    public static String DELETE_PROMOTION_SUCCESSFULLY = "You successfully deleted the promotion";
